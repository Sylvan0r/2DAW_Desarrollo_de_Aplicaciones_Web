...
function bt(){
    ...
    switch(true){
        ...
        case x>Date.parse("2016"):
            ...
            break;
        default:
            document.getElementById("result").innerHTML = "Error: Introduzca una fecha";
            break;
    }
}